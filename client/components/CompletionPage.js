...
const CompletionPage = props => {
  ...
  return (
    ...
    <div className="flex justify-center">
      <img className="w-8/12 h-8/12 justify-center"src="/congratulations.png"></img>
      </div>
      <div className="flex">
      <h1 className="text-4xl font-bold text-red-500 font-mono m-auto">You have completed <span className="text-purple-400"> level {currentTier}</span>!</h1>
      </div>
